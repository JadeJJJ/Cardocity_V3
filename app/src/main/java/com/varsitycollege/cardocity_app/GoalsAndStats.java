...
// Button Clicks------------------------------------------------------------------------------------
        ...
        checker = findViewById(R.id.lstvDeckChecker);
// OnCreate Pie Charts------------------------------------------------------------------------------
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                // convert into arrays
                Integer[] arrItemDecks = new Integer[listItemDecks.size()];
                listItemDecks.toArray(arrItemDecks);
                Integer[] arrDeckIDs = new Integer[listDeckIDs.size()];
                listDeckIDs.toArray(arrDeckIDs);
                String[] arrDeckNames = new String[listDeckNames.size()];
                listDeckNames.toArray(arrDeckNames);
                Integer[] arrNoCardsInDeck = new Integer[listNoCardsInDeck.size()];
                listNoCardsInDeck.toArray(arrNoCardsInDeck);
                ...
                for (int i = 0; i < listPercents.size(); i++)
                {
                    checked.add(listPercents.get(i).toString());
                }

                ArrayAdapter<String> spnAdapter = new ArrayAdapter<String>(GoalsAndStats.this, android.R.layout.simple_spinner_item, checked);
                spnAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                checker.setAdapter(spnAdapter); */
                    ...
                    // TODO: Make the list views visible and add the names [Name] [Percent]
